...
Stay on `PlatformServiceOptions.Null` until you add a Firebase project. Ghostgarden’s `ci/firebase.md` is the opt-in reference (SDK install, configs, ATT vs Sentry split).
